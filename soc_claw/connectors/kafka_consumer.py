...
TOPIC_ALERTS = os.environ.get("KAFKA_TOPIC_ALERTS", "soc-claw-alerts")
TOPIC_DLQ = os.environ.get("KAFKA_TOPIC_DLQ", "soc-claw-alerts-dlq")
CONSUMER_GROUP = os.environ.get("KAFKA_CONSUMER_GROUP", "soc-claw-consumers")
MAX_POLL_RECORDS = 10
